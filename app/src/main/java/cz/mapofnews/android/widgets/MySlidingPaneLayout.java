package cz.mapofnews.android.widgets;
...
public class MySlidingPaneLayout extends ViewGroup {
     ...
     */
    private static final int DEFAULT_OVERHANG_SIZE = 2; // dp;
    ...
    class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
            ...
            info.setClassName(MySlidingPaneLayout.class.getName());
            info.setSource(host);
        ...
        public void onInitializeAccessibilityEvent(View host, AccessibilityEvent event) {
            ...
            event.setClassName(MySlidingPaneLayout.class.getName());
        }
